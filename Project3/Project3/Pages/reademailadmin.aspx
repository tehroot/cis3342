<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reademailadmin.aspx.cs" Inherits="Project3.Pages.reademailadmin" %>
         ...
         <div class="navbar navbar-light bg-light navbar-expand pl-2" id="second">
            <div class="btn-toolbar w-100" role="toolbar">
                 <div class="btn-group mr-1" role="group">
                    <asp:Button id="returnAdmin" text="Return to Admin" runat="server" type="submit" CssClass="btn btn-primary" OnClick="returnAdmin_Click"/>
                </div>
            </div>
        </div>
    </div>
